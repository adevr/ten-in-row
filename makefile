...
jogo:
	gcc -o application/$(GAME_NAME) -pthread constants/constants.h helpers/helpers.c  models/Communication/Communication.c application/Game.c application/main.c

all: arbitro cliente jogo
	gcc -o teninrow -pthread constants/constants.h main.c

clean:
	#rm application/$(GAME_NAME)
	rm client/client
